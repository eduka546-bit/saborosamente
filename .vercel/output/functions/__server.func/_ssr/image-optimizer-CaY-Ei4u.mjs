//#region node_modules/.nitro/vite/services/ssr/assets/image-optimizer-CaY-Ei4u.js
/**
	...
	return new Promise((resolve, reject) => {
		...
		reader.onload = (e) => {
			...
			img.onload = () => {
				...
				canvas.toBlob((blob) => {
					if (!blob) {
						reject(/* @__PURE__ */ new Error("Could not optimize image"));
						return;
					}
					const baseName = file.name.replace(/\.[^.]+$/, "");
					resolve(new File([blob], `${baseName}.${format}`, { type: mimeType }));
				}, mimeType, quality);
			};
