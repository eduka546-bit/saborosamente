...
import { i as useCart } from "./cart-BpzhGIHb.mjs";
import { r as getSaldo } from "./cashback-duIDUfio.mjs";
import { i as CardTitle, n as CardContent, r as CardHeader, t as Card } from "./card-BXjpJ96D.mjs";
import { t as Route } from "./perfil-BWdsVJUO.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/perfil-BV0BCMuP.js
										...
										children: [
											...
											currentTaxa && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Truck, { size: 18 }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
													...
													children: ["Taxa de entrega para este local: R$ ", currentTaxa.taxa.toFixed(2).replace(".", ",")]
												})]
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												className: "grid gap-4 sm:grid-cols-2",
