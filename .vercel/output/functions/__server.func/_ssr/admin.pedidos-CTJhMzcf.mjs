...
//#region node_modules/.nitro/vite/services/ssr/assets/admin.pedidos-CTJhMzcf.js
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
												...
												children: ["R$ ", (order.valor_total - (order.desconto_aplicado || 0) + (order.taxa_entrega || 0)).toFixed(2).replace(".", ",")]
											})]
										})
									]
								})
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
										...
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DropdownMenu, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DropdownMenuTrigger, {
											...
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
												className: cn("px-3 py-1.5 rounded-full text-[10px] font-black uppercase tracking-wider flex items-center gap-2 border", order.status === "rascunho" ? "bg-gray-50 text-gray-600 border-gray-200" : order.status === "Pendente" ? "bg-yellow-50 text-yellow-600 border-yellow-200" : order.status === "Em preparo" ? "bg-blue-50 text-blue-600 border-blue-200" : order.status === "Saiu para entrega" ? "bg-purple-50 text-purple-600 border-purple-200" : order.status === "Entregue" ? "bg-green-50 text-green-600 border-green-200" : "bg-red-50 text-red-600 border-red-200"),
