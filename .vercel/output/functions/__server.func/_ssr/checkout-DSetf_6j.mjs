...
import { i as useCart, r as formatBRL } from "./cart-BpzhGIHb.mjs";
...
import { i as usarCashback, n as getCashbackConfig, r as getSaldo, t as creditarCashback } from "./cashback-duIDUfio.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/checkout-DSetf_6j.js
...
function Checkout() {
	...
	const onSubmit = async (data) => {
		...
		try {
			if (appliedCoupon) {
				const { data: cupomData } = await supabase.from("cupons").select("apenas_primeira_compra").eq("codigo", appliedCoupon.codigo).maybeSingle();
				if (cupomData?.apenas_primeira_compra && !session) {
					const { count: emailCount } = await supabase.from("pedidos").select("id", {
						count: "exact",
						head: true
					}).eq("email_cliente", data.email).neq("status", "Cancelado");
					const { count: phoneCount } = await supabase.from("pedidos").select("id", {
						count: "exact",
						head: true
					}).eq("telefone_cliente", data.telefone).neq("status", "Cancelado");
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Gift, {
											...
											className: "text-sm font-semibold",
											children: ["Cashback disponível: ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", {
