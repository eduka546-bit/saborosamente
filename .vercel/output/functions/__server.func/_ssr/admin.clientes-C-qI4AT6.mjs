...
import { t as importExistingCustomers } from "./customers.functions-DM8-ScyE.mjs";
import { t as createQueryConfig } from "./query-config-CV5KxvX3.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/admin.clientes-C-qI4AT6.js
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										...
										children: [
											"R$",
											" ",
											selectedClient.totalPedidos > 0 ? (selectedClient.valorGasto / selectedClient.totalPedidos).toFixed(2) : "0,00"
										]
									})]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
