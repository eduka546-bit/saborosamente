...
import { t as Route } from "./pedido-C6gCeZ7h.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/pedido-BpEBywpK.js
...
function RastrearPedidoPage() {
	...
	const { data: pedido, isLoading, error } = useQuery({
		...
		queryFn: async () => {
			...
			const { data, error } = await supabase.from("pedidos").select("id, nome_cliente, status, created_at, metodo_entrega, endereco_bairro, endereco_cidade, metodo_pagamento, valor_total, taxa_entrega, desconto_aplicado, itens:pedido_itens(quantidade, preco_unitario, produto_id, produtos:produto_id(nome))").ilike("id", `%${termo}`).order("created_at", { ascending: false }).limit(1);
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [(pedido.itens ?? []).map((item, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Total" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
										...
										children: ["R$ ", ((pedido.valor_total ?? 0) - (pedido.desconto_aplicado ?? 0) + (pedido.taxa_entrega ?? 0)).toFixed(2).replace(".", ",")]
									})]
								})]
							})
						]
