...
export function CartProvider({ children }: { children: ReactNode }) {
  ...
  const MOCK_TAXAS = useMemo(() => {
    const dataMap = {
      "São Bento do Sul": [
        { neighborhood: "25 de Julho", rate: 12.0 },
        { neighborhood: "Alpestre", rate: 17.0 },
        { neighborhood: "Alpino", rate: 17.5 },
        { neighborhood: "Bela Aliança", rate: 16.0 },
        { neighborhood: "Boehmerwald", rate: 12.5 },
        { neighborhood: "Brasília", rate: 13.0 },
        { neighborhood: "Campo do Meio", rate: 10.0 },
        { neighborhood: "Castelo Branco", rate: 10.0 },
        { neighborhood: "Centenário", rate: 12.0 },
        { neighborhood: "Centro", rate: 12.0 },
        { neighborhood: "Colonial", rate: 12.5 },
        { neighborhood: "Cruzeiro", rate: 13.5 },
        { neighborhood: "Dona Francisca", rate: 14.0 },
        { neighborhood: "Estrada das Neves", rate: 10.0 },
        { neighborhood: "Estrada dos Bugres", rate: 10.0 },
        { neighborhood: "Fundão", rate: 15.0 },
        { neighborhood: "Industrial Sudoeste", rate: 11.0 },
        { neighborhood: "Lençol", rate: 18.0 },
        { neighborhood: "Loteamento Itália", rate: 18.0 },
        { neighborhood: "Mato Preto", rate: 12.0 },
        { neighborhood: "Oxford", rate: 15.0 },
        { neighborhood: "Parque Mariani", rate: 13.0 },
        { neighborhood: "Progresso", rate: 11.0 },
        { neighborhood: "Residencial Santa Fé", rate: 10.5 },
        { neighborhood: "Rio Natal", rate: 10.0 },
        { neighborhood: "Rio Negro", rate: 12.25 },
        { neighborhood: "Rio Represo", rate: 17.0 },
        { neighborhood: "Rio Vermelho Estação", rate: 16.0 },
        { neighborhood: "Rio Vermelho Povoado", rate: 16.0 },
        { neighborhood: "Schramm", rate: 11.25 },
        { neighborhood: "Serra Alta", rate: 15.0 },
        { neighborhood: "Sertãozinho", rate: 10.0 },
        { neighborhood: "Urca", rate: 12.0 },
        { neighborhood: "Vila São Paulo", rate: 10.0 },
      ],
      "Rio Negrinho": [
        "Ceramarte",
        "Alegre",
