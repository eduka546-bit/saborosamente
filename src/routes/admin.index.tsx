...
import {
  ...
  ArrowRight, Truck, Star, MessageCircle
} from "lucide-react";
...
const META_MENSAL = 10000; // Você pode mover isso para site_settings futuramente
  ...
  const { data: stats, isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      const [
        ...
        // Conta tanto ativo=true quanto status="ativo" para cobrir ambos os padrões do banco
