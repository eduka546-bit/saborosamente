        ...
        <div className="grid gap-4" style={{ gridTemplateColumns: "145px 1fr", alignItems: "start" }}>
          ...
          <div>
            ...
            <div className="mt-3 rounded-xl bg-white p-3">
              ...
              <p className="text-sm"><b>2.</b> Faça cada preparação usando as quantidades impressas abaixo. Quando o ingrediente não tiver quantidade definida, considere <b>QB (quanto baste / a gosto)</b>.</p>
