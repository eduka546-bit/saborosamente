...
import { Loader2, Save, Printer, CheckCircle2, XCircle, RefreshCw, ExternalLink } from "lucide-react";
...
function AdminConfigImpressaoPage() {
  ...
  const handleTestar = async () => {
    if (!config.impressora_ip) { toast.error("Informe o IP da impressora"); return; }
    setTesting(true);
    try {
      const pedidoTeste = {
        ...
        desconto_aplicado: 0,
        itens: [
          { nome: "Frango Grelhado com Legumes", quantidade: 2, preco_unitario: 18.95, observacao: "Sem cebola" },
          { nome: "Sopa de Caldo Verde", quantidade: 1, preco_unitario: 8.00, observacao: null },
        ],
      };
  ...
  return (
    <div className="p-4 md:p-6 max-w-xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-500 text-sm mt-1">Configure a impressão automática de tickets de pedido.</p>
      </div>
        ...
        <div className="space-y-4">
          ...
          <div className={`rounded-xl border p-4 flex items-center justify-between ${
            ...
            <div className="flex items-center gap-3">
              {qzStatus === "checking" && <Loader2 size={18} className="animate-spin text-gray-400" />}
              ...
              <div>
                <p className={`text-sm font-bold ${
                  ...
                  qzStatus === "disconnected" ? "text-red-700" : "text-gray-600"
                }`}>
                  {qzStatus === "checking" ? "Verificando QZ Tray..." :
            ...
            <button onClick={checkQz} className="p-1.5 rounded-lg hover:bg-black/5 text-gray-400 hover:text-gray-600" title="Verificar novamente">
              <RefreshCw size={15} />
            </button>
          </div>
          ...
          {qzStatus === "disconnected" && (
            <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 space-y-2">
              ...
              <ol className="text-xs text-blue-700 space-y-1 list-decimal list-inside">
                <li>Você já baixou — ótimo! Agora <strong>instale e execute o QZ Tray</strong></li>
                ...
                <li>Clique em <strong>"Testar impressão"</strong> para confirmar</li>
              </ol>
          ...
          <div className="bg-white rounded-xl border p-6 space-y-5">
            ...
            <div className="space-y-4">
              <div>
                <label className="text-xs font-bold uppercase text-gray-400 mb-1 block">IP da Impressora</label>
                <Input
                ...
                <p className="text-[10px] text-gray-400 mt-1">
                  Para descobrir: ligue a impressora e segure o botão de alimentação até imprimir uma folha de teste com o IP.
                </p>
              </div>

              <div>
                <label className="text-xs font-bold uppercase text-gray-400 mb-1 block">Porta TCP</label>
                <Input
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="text-xs font-bold uppercase text-gray-400 mb-1 block">Cópias</label>
                  <Input
                    type="number"
                    min="1"
                    max="5"
                ...
                <div>
                  <label className="text-xs font-bold uppercase text-gray-400 mb-1 block">Largura do Papel</label>
                  <select
