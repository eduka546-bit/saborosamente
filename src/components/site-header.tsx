    ...
    <header className="relative z-[100] transition-all duration-300">
      ...
      <div className="relative w-full overflow-hidden bg-[#086e45]" style={{ backgroundColor: settings?.hero_bg_color || "#086e45" }}>
        ...
        {settings?.profile_image_url && (
          <div className="absolute left-1/2 bottom-0 -translate-x-1/2 translate-y-1/2 z-[110]">
            <div className="size-44 md:size-64 rounded-full border-[6px] border-[#086e45] bg-white shadow-2xl overflow-hidden flex items-center justify-center p-3">
              <img 
