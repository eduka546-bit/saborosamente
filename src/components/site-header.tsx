  ...
  return (
    <header className="relative z-[200] transition-all duration-300">
      ...
      <div className="relative w-full overflow-visible bg-[#086e45]" style={{ backgroundColor: settings?.hero_bg_color || "#086e45" }}>
        ...
        <div className="absolute left-1/2 bottom-0 -translate-x-1/2 -translate-y-2 md:-translate-y-3 z-[300] flex items-center justify-center pointer-events-none">
          <div className="size-[100px] md:size-[140px] rounded-full border-[4px] border-[#fff688] bg-[#086e45] shadow-2xl flex items-center justify-center overflow-hidden pointer-events-auto">
            <img 
